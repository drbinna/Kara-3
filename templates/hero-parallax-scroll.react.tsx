// desc: REFERENCE ONLY — original React source of hero-parallax-scroll.html (framer-motion + lenis + react-icons, shadcn-style). Use when the operator wants React/Tailwind output; otherwise adapt the .html version.
// Deps: npm i lenis react-icons framer-motion — lives in /components/ui/modern-hero.tsx in a shadcn project.
